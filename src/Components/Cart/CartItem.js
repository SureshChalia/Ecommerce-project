    ...
    <div>
      <div className='flex flex-row items-center gap-8 p-4 mt-10 ml-5 rounded-xl  border-b-2 w-100'>
        <div className='h-[150px]  '>
          <img src={item.productImage} alt="" className="h-[10rem] w-[8rem] object-contain" />
        </div>
        <div className='flex flex-col gap-3 mt-0 pt-0 w-11/12 '>
          ...
          <div className='flex justify-between'>
            <p className="text-blue-600 font-semibold">₹ {item.productPrice}</p>
            <div onClick={removeFromCart} className='bg-red-400 rounded-full hover:cursor-pointer'>
