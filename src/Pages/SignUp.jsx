    ...
    <div>
      <section className="h-screen w-11/12 flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-2 mx-5 md:mx-0 md:my-0 pt-36">
        ...
        <div className="md:w-1/3 max-w-sm ">
          ...
          <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded focus:outline-none" type="text" placeholder="Enter Your Name" name="name"
            value={name}
            onChange={handleOnChange} />
          <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded mt-4 focus:outline-none" type="email" placeholder="Enter Your Email Address" name="email"
            value={email}
            onChange={handleOnChange} />
          ...
          <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded mt-4 focus:outline-none" type="password" placeholder="Password" name="password"
            value={password}
            onChange={handleOnChange} />
          <input className="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded mt-4 focus:outline-none" type="password" placeholder="Confirm Password" name="confirmPassword"
